...
Delta = (function() {
  ...
  Delta.prototype.adjustTone = function(_arg, i) {
    ...
    if (this.drawDebug) {
      ...
      this.ctx.fillRect(this.freqStart / 2, 0, (this.freqEnd - this.freqStart) / 2, 10);
      this.ctx.fillRect(this.freqStart / 2, 10 * (i + 1), (freq - this.freqStart) / 2, 10);
      this.ctx.fillStyle = "blue";
      this.ctx.fillRect(500, 0, 100., 10);
      return this.ctx.fillRect(500, 10 * (i + 1), g * 100, 10);
    }
  };
